...
const config = {
  title: 'JakMods.dev',
  tagline: 'Welcome! Here you can find mods for the Jak and Daxter games (via OpenGOAL).',
  ...
  organizationName: 'OpenGOAL-Mods', // Usually your GitHub org/user name.
  projectName: 'jakmods.dev', // Usually your repo name.
